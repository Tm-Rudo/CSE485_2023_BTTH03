    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if($pass1 != $pass2){
                ...
                try{
                    $conn = mysqli_connect('localhost','root','','demo_membership');
                }catch(Exception $e){
                    echo $e->getMessage();
                }
                ...
                if(mysqli_num_rows($result_sql) > 0){
                    ...
                    if(mysqli_query($conn,$insert_sql)){
                        ...
                        $message = "Vui lòng bấm link sau để kích hoạt tài khoản:<a href='http://localhost/BTTH03/bai1/activation.php?user=$user&code=$code_hash'>
                        http://localhost/BTTH03/bai1/activation.php?user=$user&code=$code_hash</a>";
